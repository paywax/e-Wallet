 ...
 */
namespace Paywax\Wallet\Test\Unit\Gateway\Validator;

use Magento\Payment\Gateway\Validator\ResultInterface;
use Magento\Payment\Gateway\Validator\ResultInterfaceFactory;
use Paywax\Wallet\Gateway\Http\Client\PaywaxWalletClient;
use Paywax\Wallet\Gateway\Validator\ResponseCodeValidator;
...
class ResponseCodeValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function validateDataProvider()
    {
        return [
            ...
            'fail_2' => [
                'response' => [ResponseCodeValidator::RESULT_CODE => PaywaxWalletClient::FAILURE],
                'expectationToResultCreation' => [
                    'isValid' => false,
                    'failsDescription' => [__('Gateway rejected the transaction.')]
                ]
            ...
            'success' => [
                'response' => [ResponseCodeValidator::RESULT_CODE => PaywaxWalletClient::SUCCESS],
                'expectationToResultCreation' => [
                    'isValid' => true,
                    'failsDescription' => []
                ]
